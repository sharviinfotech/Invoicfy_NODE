module.exports = (() => {
    ...
    return {
        ...
        productmasterCreation: (req, res) => userMethods.productmasterCreation(req, res),
        productmasterUpdate: (req, res) => userMethods.updateProductmaster(req, res),
        getproductlist: (req, res) => userMethods.listOfProduct(req, res),
